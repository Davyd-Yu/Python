...
class BicycleManager:
    ...
    def __iter__(self):
        """Returns an iterator for the bicycles collection."""
        return iter(self.bicycles)

    def __len__(self):
        """Returns the length of the bicycles collection."""
        return len(self.bicycles)

    def __getitem__(self, item):
        """Gets a bicycle from the collection by index."""
    ...
    def zip_return(self):
        """Returns a list of tuples containing a string representation of each bicycle and its maximum distance."""
    ...
    def all_and_any(self, condition):
        """
        Checks if all or any of the bicycles in the collection satisfy the given condition.
